  ...
  return (
    <form className={styles.form} onSubmit={handleSubmit(onSubmit)}>
      <div className={styles.inputContainer}>
        ...
        <input className={styles.inputCustom} type="text" id="email" {...register('email')} />
        {errors?.email && (
      ...
      <div className={styles.inputContainer}>
        ...
        <input className={styles.inputCustom} type="password" id="password" {...register('password')} />
        {errors?.password && (
      ...
      <div className={styles.inputContainer}>
        ...
        <input className={styles.inputCustom} type="password" id="password2" {...register('password2')} />
        {errors?.password2 && (
          <span className={styles.errorText}>{errors.password2.message}</span>
        )}
      </div>
